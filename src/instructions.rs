...
pub(crate) const LOGIC_TYPE_DOCS: phf::Map<&'static str, &'static str> = phf_map! {
    ...
    "RatioCarbonDioxide" => "The ratio of {GAS:CarbonDioxide} in device atmosphere",
    ...
    "RatioNitrousOxide" => "The ratio of {GAS:NitrousOxide} in device atmosphere",
    ...
    "RatioCarbonDioxideInput" => "The ratio of {GAS:CarbonDioxide} in device's input network",
    ...
    "RatioNitrousOxideInput" => "The ratio of {GAS:NitrousOxide} in device's input network",
    ...
    "RatioCarbonDioxideInput2" => "The ratio of {GAS:CarbonDioxide} in device's Input2 network",
    ...
    "RatioNitrousOxideInput2" => "The ratio of {GAS:NitrousOxide} in device's Input2 network",
    ...
    "RatioCarbonDioxideOutput" => "The ratio of {GAS:CarbonDioxide} in device's Output network",
    ...
    "RatioNitrousOxideOutput" => "The ratio of {GAS:NitrousOxide} in device's Output network",
    ...
    "RatioCarbonDioxideOutput2" => "The ratio of {GAS:CarbonDioxide} in device's Output2 network",
    ...
    "RatioNitrousOxideOutput2" => "The ratio of {GAS:NitrousOxide} in device's Output2 network",
